...
namespace ToDo.Utility
{
    public static class TaskScheduler
    {
        ...
        public static IEnumerable<ToDoModel> ZenData(AppDbCon DbData, int increaseDate = 0)
        {
        ...
        public static IEnumerable<(string, IEnumerable<ToDoModel>)> SevenDaysData(AppDbCon DbData)
        {
