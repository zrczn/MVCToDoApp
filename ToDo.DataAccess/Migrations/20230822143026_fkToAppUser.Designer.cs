...
namespace ToDo.DataAccess.Migrations
{
    ...
    [Migration("20230822143026_fkToAppUser")]
    partial class fkToAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDo.Models.ToDoModel", b =>
                {
                    b.HasOne("ToDo.Models.AudioModel", "Audio")
                        .WithMany()
                        .HasForeignKey("AudioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ToDo.Models.ApplicationUser", "OwnedBy")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ToDo.Models.PhotoModel", "Photo")
                        .WithMany()
